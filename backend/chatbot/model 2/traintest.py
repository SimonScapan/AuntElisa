...
manager = tf.train.CheckpointManager(checkpoint, '/content/drive/My Drive/Model2', max_to_keep = 300)
...
with open('/content/drive/My Drive/Model2/training_history.pkl', 'rb') as f:
...
for ep in range(current_ep,EPOCHS-last_stopped):
  ...
  #  print(f'Test-Loss of epoche {ep+last_stopped}: {test_loss}')
  ...
  with open('/content/drive/My Drive/Model2/training_history.pkl', 'wb') as f:
