...
Original file is located at
    https://colab.research.google.com/drive/1u0_u8OpwhQzMd8gq9xloYoxEiAuSqyHA
"""
...
try:
  checkpoint.restore(f"/content/drive/My Drive/Data Exploration Project-{last_stopped}.index")
...
for ep in range(current_ep,EPOCHS-last_stopped):
  ...
  if ep %10==0:
    ...
    print(f'Test-Loss of epoche {ep}: {test_loss}')
