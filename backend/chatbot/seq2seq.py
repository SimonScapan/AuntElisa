...
Original file is located at
    https://colab.research.google.com/drive/1kcQzrlffSTp6WiopOwBl6GfdccLnrjZX
"""
...
if __name__ == "__main__":
    ...
    last_stopped = 22 #0 if you are training the model from scratch
    num_epochs = 50 - last_stopped #Zahl der Trainigsepochen
    vocabulary_size = src_vocab_size
    


    def inference(seed, top_n): #Funktion, die die wahrscheinlichstenn Ausgaben des modells ausgibt
        model_.eval()
    ...
    try:
      load_weights = tl.files.load_npz(name=f'drive/My Drive/Data Exploration Project/model_epoche{last_stopped}.npz')
    ...
    for epoch in range(num_epochs):
        ...
        tl.files.save_npz(model_.all_weights, name=f'drive/My Drive/Data Exploration Project/model_epoche{epoch+1+last_stopped}.npz')
        os.remove(f'drive/My Drive/Data Exploration Project/model_epoche{epoch+last_stopped}.npz', dir_fd=None)  
    tl.files.save_npz(model_.all_weights, name='drive/My Drive/Data Exploration Project/model_final.npz')